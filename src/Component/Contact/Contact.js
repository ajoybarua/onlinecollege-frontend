...
const Contact = () => {
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_i8ie5mf', 'template_avrndva', e.target,"OMVTrZJ8Q7HWM7UVX")
      .then((result) => {
        ...
        <div class="container px-5 py-24 mx-auto flex">
          <div class="lg:w-1/3 md:w-1/2 bg-slate-800 text-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <form onSubmit={sendEmail}>
              ...
              <button type='submit' class="text-white w-full bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
            </form>
